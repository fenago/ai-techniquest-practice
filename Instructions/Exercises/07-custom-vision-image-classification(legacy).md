...
![Upload apple with apple tag](https://raw.githubusercontent.com/fenago/ai-techniquest-practice/main/Instructions/media/upload_apples.jpg)
...
![Tagged images of fruit - 15 apples, 15 bananas, and 15 oranges](https://raw.githubusercontent.com/fenago/ai-techniquest-practice/main/Instructions/media/fruit.jpg)
...
![An image with a class prediction of apple](https://raw.githubusercontent.com/fenago/ai-techniquest-practice/main/Instructions/media/test-apple.jpg)
...
1. In Visual Studio Code, in the **Explorer** pane, browse to the **07-custom-vision-image-classification** folder and expand the **Python** folder.
...
4. Open the code file for your client application (*test-classification.py* for Python) and review the code it contains, noting the following details:
    - Namespaces from the package you installed are imported
